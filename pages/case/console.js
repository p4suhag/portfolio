  ...
  return (
    <div className="case_study">
      ...
      <div className="case_study_section">
        <div className="container">
          <h2>Console</h2>
          <p>Console is an experimentation platform designed for Gojek to try out new ideas and validate hypotheses. It helps the organisation in making data-informed decisions.<br/> This case study is about how we evolved a product by taking a user-centric approach.</p>
        </div>
